...
class SSHTest extends \PHPUnit_Framework_TestCase
{
    public function testValidConfiguration()
    {
        ...
        new SSH(['port' => 1443, 'public_key' => $fakePublicKey]);
    ...
    {
        new SSH(['port' => 'not_a_number']);
    }

    public function testGetConnectionString()
    {
        $ssh = new SSH(['username' => 'test', 'host' => 'test.com']);
    ...
    {
        $ssh = new SSH(['username' => 'test', 'host' => 'test.com', 'port' => 231]);
    ...
    public function testGetConnectionWithPublicKey()
    {
        ...
        $ssh = new SSH(['username' => 'test', 'host' => 'test.com', 'public_key' => $publicKey]);
    ...
    {
        $ssh = new SSH(['username' => 'test', 'host' => 'test.com', 'port' => 231, 'public_key' => '/dev/null']);
    ...
    {
        $ssh = new SSH(['username' => 'test', 'host' => 'test.com', 'port' => 231, 'executable' => 'c:/cygwin/bin/ssh.exe']);
